...
**versions** | [**Array&lt;WorkflowPackageVersion&gt;**](WorkflowPackageVersion.md) |  | [default to undefined]

## Example

```typescript
import { WorkflowPackageDetail } from './api';

const instance: WorkflowPackageDetail = {
    id,
    slug,
    displayName,
    summary,
