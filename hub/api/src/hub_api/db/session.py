"""Database session and engine helpers for hub."""
...
DEFAULT_DB_PATH = PROJECT_ROOT / "var" / "data" / "hub.db"


def _resolve_database_url() -> str:
    raw_url = os.getenv("ASTRAFLOW_HUB_DATABASE_URL") or os.getenv("HUB_DATABASE_URL")
    if not raw_url:
