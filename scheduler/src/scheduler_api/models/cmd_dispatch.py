...
class CmdDispatch(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["kind", "runId", "nodeId", "definitionHash", "trace", "payload"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CmdDispatch from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CmdDispatch from a dict"""
        if obj is None:
            return None
