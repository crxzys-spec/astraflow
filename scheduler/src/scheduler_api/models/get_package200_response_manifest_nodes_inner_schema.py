...
class GetPackage200ResponseManifestNodesInnerSchema(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GetPackage200ResponseManifestNodesInnerSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GetPackage200ResponseManifestNodesInnerSchema from a dict"""
        if obj is None:
            return None
