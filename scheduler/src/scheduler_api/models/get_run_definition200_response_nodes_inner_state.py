...
from scheduler_api.models.get_run_definition200_response_nodes_inner_state_error import GetRunDefinition200ResponseNodesInnerStateError
...
class GetRunDefinition200ResponseNodesInnerState(object):
    """
    ...
    error: Optional[GetRunDefinition200ResponseNodesInnerStateError] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GetRunDefinition200ResponseNodesInnerState from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GetRunDefinition200ResponseNodesInnerState from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "error": GetRunDefinition200ResponseNodesInnerStateError.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
