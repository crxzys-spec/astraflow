...
class GetRunDefinition200ResponseNodesInnerUiWidgetsInner(object):
    """
    GetRunDefinition200ResponseNodesInnerUiWidgetsInner
    """ # noqa: E501
    key: StrictStr
    label: StrictStr
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GetRunDefinition200ResponseNodesInnerUiWidgetsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GetRunDefinition200ResponseNodesInnerUiWidgetsInner from a dict"""
        if obj is None:
            return None
