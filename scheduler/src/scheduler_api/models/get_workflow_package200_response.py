...
class GetWorkflowPackage200Response(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GetWorkflowPackage200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GetWorkflowPackage200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "versions": [ListWorkflowPackages200ResponseItemsInnerLatestVersion.from_dict(_item) for _item in obj.get("versions")] if obj.get("versions") is not None else None
        })
        return _obj
