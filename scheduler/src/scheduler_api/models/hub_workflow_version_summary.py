...
class HubWorkflowVersionSummary(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "version", "publishedAt", "changelog"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of HubWorkflowVersionSummary from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of HubWorkflowVersionSummary from a dict"""
        if obj is None:
            return None
