...
class ListRuns200Response(BaseModel):
    ...
    ListRuns200Response
    """ # noqa: E501
    items: List[ListRuns200ResponseItemsInner]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "items": [ListRuns200ResponseItemsInner.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
