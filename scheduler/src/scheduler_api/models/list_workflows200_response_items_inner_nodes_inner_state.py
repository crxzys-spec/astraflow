...
from scheduler_api.models.start_run_request_workflow_nodes_inner_state_error import StartRunRequestWorkflowNodesInnerStateError
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class ListWorkflows200ResponseItemsInnerNodesInnerState(object):
    """
    ...
    error: Optional[StartRunRequestWorkflowNodesInnerStateError] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ListWorkflows200ResponseItemsInnerNodesInnerState from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ListWorkflows200ResponseItemsInnerNodesInnerState from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "error": StartRunRequestWorkflowNodesInnerStateError.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
