...
from scheduler_api.models.manifest_port import ManifestPort
from scheduler_api.models.manifest_widget import ManifestWidget
try:
...
class ManifestNodeUI(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ManifestNodeUI from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ManifestNodeUI from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "inputPorts": [ManifestPort.from_dict(_item) for _item in obj.get("inputPorts")] if obj.get("inputPorts") is not None else None,
            "outputPorts": [ManifestPort.from_dict(_item) for _item in obj.get("outputPorts")] if obj.get("outputPorts") is not None else None,
