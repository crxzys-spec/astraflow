...
class ManifestPermissionRequirement(BaseModel):
    """
    ManifestPermissionRequirement
    """ # noqa: E501
    key: StrictStr = Field(description="Stable permission identifier used for grants.")
    types: Annotated[List[StrictStr], Field(min_length=1)] = Field(description="Resource types covered by this permission (file, image, audio, video, kv, secret, etc.).")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ManifestPermissionRequirement from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ManifestPermissionRequirement from a dict"""
        if obj is None:
            return None
