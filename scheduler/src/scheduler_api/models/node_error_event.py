...
class NodeErrorEvent(BaseModel):
    ...
    error: ResultError
    __properties: ClassVar[List[str]] = ["kind", "runId", "nodeId", "error"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of NodeErrorEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of NodeErrorEvent from a dict"""
        if obj is None:
            return None
