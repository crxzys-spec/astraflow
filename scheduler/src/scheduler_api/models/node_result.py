...
from scheduler_api.models.node_result_metadata import NodeResultMetadata
try:
...
class NodeResult(BaseModel):
    ...
    metadata: Optional[NodeResultMetadata] = None
    __properties: ClassVar[List[str]] = ["kind", "runId", "nodeId", "status", "definitionHash", "outputs", "metadata"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "metadata": NodeResultMetadata.from_dict(obj.get("metadata")) if obj.get("metadata") is not None else None
        })
        return _obj
