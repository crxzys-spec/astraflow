...
class NodeStateEvent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["kind", "runId", "nodeId", "state"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of NodeStateEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of NodeStateEvent from a dict"""
        if obj is None:
            return None
