...
class PackageDetail1(BaseModel):
    """
    PackageDetail1
    """ # noqa: E501
    name: StrictStr
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PackageDetail1 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PackageDetail1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "manifest": PackageManifest1.from_dict(obj.get("manifest")) if obj.get("manifest") is not None else None
        })
        return _obj
