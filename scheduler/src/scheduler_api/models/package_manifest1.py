...
from scheduler_api.models.manifest_node1 import ManifestNode1
...
class PackageManifest1(BaseModel):
    """
    PackageManifest1
    """ # noqa: E501
    ...
    nodes: Annotated[List[ManifestNode1], Field(min_length=1)]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PackageManifest1 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PackageManifest1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "nodes": [ManifestNode1.from_dict(_item) for _item in obj.get("nodes")] if obj.get("nodes") is not None else None,
