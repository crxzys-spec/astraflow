...
class PublishedPackageRegistry(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "ownerId", "visibility", "state", "createdAt", "updatedAt", "createdBy", "updatedBy"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PublishedPackageRegistry from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PublishedPackageRegistry from a dict"""
        if obj is None:
            return None
