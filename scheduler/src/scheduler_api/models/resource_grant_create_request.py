...
class ResourceGrantCreateRequest(BaseModel):
    ...
    actions: Optional[List[ResourceGrantAction]] = None
    metadata: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["resourceId", "packageName", "packageVersion", "resourceKey", "scope", "workflowId", "actions", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ResourceGrantCreateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ResourceGrantCreateRequest from a dict"""
        if obj is None:
            return None
