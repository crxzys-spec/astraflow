...
class RunMetricsEvent(BaseModel):
    """
    RunMetricsEvent
    """ # noqa: E501
    kind: Optional[Any]
    ...
    __properties: ClassVar[List[str]] = ["kind", "runId", "metric", "value", "tags"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of RunMetricsEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of RunMetricsEvent from a dict"""
        if obj is None:
            return None
