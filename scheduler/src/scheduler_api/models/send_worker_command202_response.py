...
class SendWorkerCommand202Response(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SendWorkerCommand202Response from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SendWorkerCommand202Response from a dict"""
        if obj is None:
            return None
