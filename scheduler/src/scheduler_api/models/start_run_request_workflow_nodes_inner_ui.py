...
class StartRunRequestWorkflowNodesInnerUi(object):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of StartRunRequestWorkflowNodesInnerUi from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of StartRunRequestWorkflowNodesInnerUi from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "inputPorts": [StartRunRequestWorkflowNodesInnerUiInputPortsInner.from_dict(_item) for _item in obj.get("inputPorts")] if obj.get("inputPorts") is not None else None,
