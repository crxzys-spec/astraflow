...
from scheduler_api.models.start_run_request_workflow_nodes_inner_ui_widgets_inner_options import StartRunRequestWorkflowNodesInnerUiWidgetsInnerOptions
try:
...
class StartRunRequestWorkflowNodesInnerUiWidgetsInner(object):
    ...
    options: Optional[StartRunRequestWorkflowNodesInnerUiWidgetsInnerOptions] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "options": StartRunRequestWorkflowNodesInnerUiWidgetsInnerOptions.from_dict(obj.get("options")) if obj.get("options") is not None else None
        })
