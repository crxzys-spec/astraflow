...
class TraceContext(BaseModel):
    ...
    baggage: Optional[Dict[str, StrictStr]] = None
    __properties: ClassVar[List[str]] = ["traceId", "spanId", "parentSpanId", "baggage"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of TraceContext from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if baggage (nullable) is None
        # and model_fields_set contains the field
        if self.baggage is None and "baggage" in self.model_fields_set:
            _dict['baggage'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of TraceContext from a dict"""
        if obj is None:
            return None
