...
from scheduler_api.models.binding_scope import BindingScope
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class UIBinding1(BaseModel):
    """
    UIBinding1
    """ # noqa: E501
    path: StrictStr = Field(description="e.g. parameters.url / results.status")
    mode: StrictStr
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UIBinding1 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UIBinding1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "scope": BindingScope.from_dict(obj.get("scope")) if obj.get("scope") is not None else None
        })
        return _obj
