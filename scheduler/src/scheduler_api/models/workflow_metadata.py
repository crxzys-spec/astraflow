...
class WorkflowMetadata(BaseModel):
    ...
    origin_id: Optional[UUID] = Field(default=None, description="Identifier linking versions of the same workflow. By default equals the workflow id.", alias="originId")
