...
from scheduler_api.models.node_ui1 import NodeUI1
from scheduler_api.models.workflow_middleware1 import WorkflowMiddleware1
...
class WorkflowNode1(BaseModel):
    ...
    ui: Optional[NodeUI1] = None
    middlewares: Optional[List[WorkflowMiddleware1]] = Field(default=None, description="Ordered list of middleware definitions attached to this node.")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WorkflowNode1 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WorkflowNode1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "ui": NodeUI1.from_dict(obj.get("ui")) if obj.get("ui") is not None else None,
            "middlewares": [WorkflowMiddleware1.from_dict(_item) for _item in obj.get("middlewares")] if obj.get("middlewares") is not None else None
        })
        return _obj
