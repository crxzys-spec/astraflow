...
class WorkflowPackageSummary1(BaseModel):
    """
    WorkflowPackageSummary1
    """ # noqa: E501
    id: StrictStr
    slug: StrictStr
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WorkflowPackageSummary1 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WorkflowPackageSummary1 from a dict"""
        if obj is None:
            return None
